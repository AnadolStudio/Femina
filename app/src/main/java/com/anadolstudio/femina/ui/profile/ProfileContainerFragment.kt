...
class ProfileContainerFragment : BaseFragmentContainer(R.layout.fragment_profile_container) {
    ...
    private val navigator: Navigator by lazy {
        BottomNavigator(
                ...
                containerId = R.id.fragment_profile_container_screens,
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        if (childFragmentManager.findFragmentById(R.id.fragment_profile_container_screens) == null) {
    ...
    override fun getDefaultScreen(): String = Screens.BottomNavigation.PROFILE
