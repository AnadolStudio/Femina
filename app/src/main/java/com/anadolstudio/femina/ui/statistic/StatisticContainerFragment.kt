...
class StatisticContainerFragment : BaseFragmentContainer(R.layout.fragment_statistic_container) {

    companion object {
        fun newInstance() = StatisticContainerFragment()
    }
    ...
    private val navigator: Navigator by lazy {
        BottomNavigator(
                ...
                containerId = R.id.fragment_statistic_container_screens,
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        if (childFragmentManager.findFragmentById(R.id.fragment_statistic_container_screens) == null) {
    ...
    override fun getDefaultScreen(): String = Screens.BottomNavigation.STATISTIC
