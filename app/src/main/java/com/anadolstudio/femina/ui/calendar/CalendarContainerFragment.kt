...
class CalendarContainerFragment : BaseFragmentContainer(R.layout.fragment_calendar_container) {

    companion object {
        fun newInstance() = CalendarContainerFragment()
    }

    @field:[Inject Named(Screens.BottomNavigation.CALENDAR_SECTION_QUALIFIER)]
    ...
    private val navigator: Navigator by lazy {
        BottomNavigator(
                ...
                containerId = R.id.fragment_calendar_container_screens,
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        if (childFragmentManager.findFragmentById(R.id.fragment_calendar_container_screens) == null) {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        DI.app.calendarScreen.provideComponent().inject(this)
    }
    ...
    override fun getDefaultScreen(): String = Screens.BottomNavigation.CALENDAR
